...
- To watch traffic live: `./build_companion.sh --build --upload --monitor` (or `--upload --monitor` if firmware is already built) and look for the DHCP IP before connecting the client.
